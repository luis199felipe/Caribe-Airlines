...
//        int n = tamanio;
//        
//        Nodo aux1 = nodoPrimero;
//        for (int m = n; m >= 0; m--) {
//        	Nodo aux2 = aux1.getSiguienteNodo();
//        	for (int i = 0; i < n - 2; i++) {
//        		aux2 = aux2.getSiguienteNodo();
//        		System.out.println("va a comprarar "+aux1.getValorNodo()+" con "+aux2.getValorNodo());
//                if (comparar(aux1.getValorNodo() , aux2.getValorNodo())) {
//                    swapNumbers(aux1,aux2);
//                }
//            }
...
//    }
//  
//    public boolean comparar(Object object,Object object2) {
//    	int v = (int) object;
//    	int vv = (int) object2;
//    	if (v>vv) {
//			return true;
...
//    }
//    
//    private void swapNumbers(Nodo<T> n1,Nodo<T> n2) {
//    	System.out.println("Hasta aqui");
//    	T aux = n1.getValorNodo();
//    	n1.setValorNodo(n2.getValorNodo());
//    	n2.setValorNodo(aux);
//    }
//	
